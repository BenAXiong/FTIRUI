        ...
        "plans": [
            {
                ...
                "features": [
                    "Drag-and-drop data import with data guess",
                    "Graphs, tables, notes, and images in one canvas",
                    "Lightning-fast figure styling with reusable themes",
                    "Publication-ready exports",
                    "Dashboard with unlimited projects",
                    "3 editable canvases",
                ],
                "upcoming_features": [],
            ...
            },
            {
                ...
                "eyebrow": "Recommended",
                "title": "Pro",
                "subtitle": "Unlimited workspace",
                "price": "$4",
                "description": "Per month with annual subscription ($48 billed up front). $5 if billed monthly.",
                "features": [
